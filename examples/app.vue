    ...
    <div class='v2-list-example'>
        ...
        <div class="start">
            ...
            <div class="register">
                ...
                <pre>&lt;v2-lazy-list :data='data'&gt;&lt;/v2-lazy-list&gt;</pre>
            </div>  
            <br>
        </div>
